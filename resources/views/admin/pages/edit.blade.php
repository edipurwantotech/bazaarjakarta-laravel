            ...
            <form action="{{ route('admin.pages.update', $page) }}" method="POST">
                ...
                <div class="form-control mb-6">
                    ...
                    <div class="input input-bordered bg-base-200 flex items-center gap-2">
                        ...
                        <span id="slugPreview" class="font-mono text-sm">{{ $page->slug }}</span>
                    </div>
                    <label class="label">
                ...
                <div class="form-control mb-6">
                    ...
                    <div class="flex gap-4">
                        <label class="cursor-pointer">
                            <input type="radio" name="status" value="draft" class="radio radio-primary" {{ old('status', $page->status) == 'draft' ? 'checked' : '' }}>
                            <span class="ml-2">Draft</span>
                        </label>
                        <label class="cursor-pointer">
                            <input type="radio" name="status" value="published" class="radio radio-primary" {{ old('status', $page->status) == 'published' ? 'checked' : '' }}>
                ...
                <div class="alert alert-info mb-6">
                    ...
                    <div>
                        <p class="font-semibold">Page Information</p>
                        <p class="text-sm">Created: {{ $page->created_at->format('d M Y H:i') }}</p>
                        <p class="text-sm">Last Updated: {{ $page->updated_at->format('d M Y H:i') }}</p>
                        <p class="text-sm">Author: {{ $page->creator?->name ?? 'Unknown' }}</p>
                    </div>
                </div>
        ...
        <div class="card-body p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600">Once you delete a page, there is no going back.</p>
                </div>
